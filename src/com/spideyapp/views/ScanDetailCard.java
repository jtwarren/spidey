...
public class ScanDetailCard extends RecyclableCard {

	public ScanDetailCard(String titlePlay, String description, String color,
	...
	protected int getCardLayoutId() {
		return R.layout.card_scan_detail;
	}
